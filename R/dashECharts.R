...
dashECharts <- function(id=NULL, amap_token=NULL, axis_data=NULL, bmap_token=NULL, brush_data=NULL, click_data=NULL, event=NULL, fun_afters=NULL, fun_befores=NULL, fun_keys=NULL, fun_loaded=NULL, fun_paths=NULL, fun_values=NULL, funs=NULL, mapbox_token=NULL, maps=NULL, n_clicks=NULL, n_clicks_timestamp=NULL, option=NULL, reset_id=NULL, resize_id=NULL, selected_data=NULL, style=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'amap_token', 'axis_data', 'bmap_token', 'brush_data', 'click_data', 'event', 'fun_afters', 'fun_befores', 'fun_keys', 'fun_loaded', 'fun_paths', 'fun_values', 'funs', 'mapbox_token', 'maps', 'n_clicks', 'n_clicks_timestamp', 'option', 'reset_id', 'resize_id', 'selected_data', 'style'),
        package = 'dashEcharts'
        )
